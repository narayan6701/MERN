...
//app.get is a method in Express.js used to handle GET requests. It takes two parameters, the first one is the path of the request and the second one is a callback function that will be called when the app receives a GET request on the specified path.
...
app.get("/apple", (req, res) => {
  res.send("Contacted apple path");
});

app.get("/orange", (req, res) => {
  res.send("Contacted orange path");
});

// setting path to "*" means if the request is for an invalid route, then this route will be called.

app.get("*", (req, res)=>{
  res.send("Page not found");
})

// app.post is used to handle POST requests. It takes two parameters, the first one is the path of the request and the second one is a callback function that will be called when the app receives a POST request on the specified path.

app.post("/", (req, res) => {
  res.send("you sent a post request on root path");
});